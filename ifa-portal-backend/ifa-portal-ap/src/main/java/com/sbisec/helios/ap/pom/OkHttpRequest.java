...
public class OkHttpRequest {
    ...
    public void setHeaders(Object obj) throws PomException {
        ...
        try {
            ...
            if (!StringUtil.isNullOrEmpty(PomConfig.getCanary())) {
                // テスト環境指定
                this.headers.put("canary", PomConfig.getCanary());
            }
            if (!StringUtil.isNullOrEmpty(PomConfig.getPomEnv())) {
                // テスト環境指定
                this.headers.put("pom-env", PomConfig.getPomEnv());
            }
