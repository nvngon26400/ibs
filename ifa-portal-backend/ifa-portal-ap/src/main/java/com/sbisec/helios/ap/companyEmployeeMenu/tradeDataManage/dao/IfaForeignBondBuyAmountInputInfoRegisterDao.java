 ...
 * @author CuongHD
 */
public interface IfaForeignBondBuyAmountInputInfoRegisterDao
{
     ...
     * @exception Exception SQLExceptionなど
     */
    public Integer selectIfaForeignBondBuyAmountInputInfoRegisterSql002(IfaForeignBondBuyAmountInputInfoRegisterSql002RequestModel req)
            throws Exception;
}
