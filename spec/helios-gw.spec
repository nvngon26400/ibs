...
Version:    %{version}
Release:    %{release}
Summary:    Helios Gateway
License:    Proprietary
Source0:    ifa-portal-gw.war
AutoReqProv: no
BuildArch:  noarch
...
unzip -d %{buildroot}/opt/apache-tomcat/webapps/gw -q %{SOURCE0}
%{__rm} -f %{SOURCE0}
...
%post
rm -f /opt/apache-tomcat/webapps/gw.war

# The list of files that will be installed in the end user's system.
%files
%defattr(644,ifauser,ifauser,755)
%dir /opt/apache-tomcat/webapps/gw
/opt/apache-tomcat/webapps/gw/*
